    ...
    <section id="slide-06" className="slide slide-light" ref={ref}>
      <div className="w-full max-w-5xl px-4 flex flex-col md:flex-row items-center gap-6">
        ...
        <div className="flex-1 flex flex-col items-center">
          ...
          <p className="font-sans text-xs text-center mb-2" style={{ color: '#C4A882' }}>
        ...
        <div className="flex-1 flex flex-col gap-3">
          ...
          {COMPONENTS.map((c, i) => (
            ...
            >
              ...
              <div>
                <p className="font-sans font-semibold text-sm" style={{ color: '#1C1208' }}>
                  {c.label}
                </p>
                <p className="font-sans text-xs" style={{ color: '#888', lineHeight: 1.4 }}>
                  {c.desc}
                </p>
              </div>
            </motion.div>
          ...
          <AnimatePresence>
            {active !== null && (
              ...
              >
                <p className="font-sans text-xs italic" style={{ color: '#555' }}>
                  {COMPONENTS[active].example}
                </p>
              </motion.div>
            )}
          </AnimatePresence>
